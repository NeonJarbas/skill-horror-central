...
class HorrorCentralSkill(OVOSCommonPlaybackSkill):
    ...
    def _sync_db(self):
        url = "https://www.youtube.com/channel/UC_MyK1SmeN2Sji4uBEckYaA"
    ...
    def search_db(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "horrorcentral"):
