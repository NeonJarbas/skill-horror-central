...
class HorrorCentralSkill(OVOSCommonPlaybackSkill):
    ...
    def _sync_db(self):
        bootstrap = "https://github.com/JarbasSkills/skill-horror-central/raw/dev/bootstrap.json"
    ...
    def load_ocp_keywords(self):
        title = []
        genre = ["horror", "scary", "slasher", "zombie", "monster"]
    ...
    def get_playlist(self, score=50, num_entries=25):
        ...
        return {
            ...
            "title": "Horror Central (Movie Playlist)",
            "author": "Horror Central"
        }
...
if __name__ == "__main__":
    ...
    s = HorrorCentralSkill(bus=FakeBus(), skill_id="t.fake")
    for r in s.search_db("play BIGFOOT VS ZOMBIES", MediaType.MOVIE):
        print(r)
        # {'title': 'BIGFOOT VS ZOMBIES (Monster Horror Movie) | Horror Central', 'author': 'Horror Central', 'match_confidence': 75, 'media_type': <MediaType.MOVIE: 10>, 'uri': 'youtube//https://youtube.com/watch?v=YRhCaz8kjAg', 'playback': <PlaybackType.VIDEO: 1>, 'skill_icon': 'https://github.com/OpenVoiceOS/ovos-ocp-audio-plugin/raw/master/ovos_plugin_common_play/ocp/res/ui/images/ocp.png', 'skill_id': 't.fake', 'image': 'https://i.ytimg.com/vi/YRhCaz8kjAg/sddefault.jpg', 'bg_image': 'https://i.ytimg.com/vi/YRhCaz8kjAg/sddefault.jpg'}
